...
def _ensure_same_shape_1d(name1: str, arr1: np.ndarray, name2: str, arr2: np.ndarray):
    """
...
def _ensure_string(name: str, value):
    """
...
def _ensure_same_length(name1: str, arr1, name2: str, arr2) -> None:
    """
    ...
    Examples
    --------
    >>> _ensure_same_length("X", [1,2,3], "y", [0,1,0])
    >>> _ensure_same_length("X", [1,2], "y", [0,1,0])
    Traceback (most recent call last):
        ...
