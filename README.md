...
**src/ml/**: This directory contains the source code for our custom ML library, implementing foundational algorithms.

**examples/**: This folder contains Jupyter notebooks demonstrating how to install, import, and utilize the ML package for various tasks (e.g., classification, regression, clustering). Each notebook also includes readmes that provide detailed explanations for the functions used within the package.

<br>

<sub>A variety of AI tools, including large language models (LLMs), were utilized in making this project, including for writing code, readmes and tests, and creating examples.</sub>
